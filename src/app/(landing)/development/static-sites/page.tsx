  ...
  return (
    <div className='bg-white dark:bg-[#0B1120] px-4 md:px-20 py-12 md:py-24'>
      <div className='mx-auto w-full max-w-4xl'>
        ...
        <div className='mt-12'>
          <form
            action={htmlCssFormSubmission}
            method='POST'
            className='relative bg-white dark:bg-gray-900 shadow-xl p-6 md:p-10 rounded-lg'>
            <div className='top-0 left-1/2 absolute flex justify-center items-center bg-gradient-to-r from-[#E44D26] to-[#1572B6] shadow-lg rounded-full w-16 md:w-20 h-16 md:h-20 transform -translate-x-1/2'>
              <FaHtml5 className='text-2xl text-white md:text-3xl' />
              <FaCss3Alt className='ml-2 text-2xl text-white md:text-3xl' />
            </div>
