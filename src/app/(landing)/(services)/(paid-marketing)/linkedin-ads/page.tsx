      ...
      <section className='flex md:flex-row flex-col-reverse items-center gap-10 mx-auto my-12 px-6 max-w-7xl'>
        <div className='md:w-1/2'>
          <h1 className='mb-4 font-extrabold text-zinc-900 dark:text-white text-4xl'>
            Expert LinkedIn Ads Management
          </h1>
          <p className='mb-6 text-zinc-700 dark:text-zinc-300 text-lg leading-relaxed'>
            Connect with professionals and decision-makers using LinkedIn’s
            powerful ad platform. Let 3Zero Digital optimize your campaigns for
            maximum B2B impact.
          </p>
          <Button className='p-5' asChild>
            <Link href='#getStarted'>Start My LinkedIn Campaign</Link>
          </Button>
        </div>
        <div className='flex justify-center md:w-1/2'>
          <SiLinkedin className='w-48 h-48 text-blue-700' />
        </div>
      </section>
