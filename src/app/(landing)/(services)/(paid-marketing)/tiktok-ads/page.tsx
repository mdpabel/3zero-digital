      ...
      <section className='flex md:flex-row flex-col-reverse items-center gap-10 mx-auto my-12 px-6 max-w-7xl'>
        <div className='md:w-1/2'>
          <h1 className='mb-4 font-extrabold text-zinc-900 dark:text-white text-4xl'>
            Expert TikTok Ads Management
          </h1>
          <p className='mb-6 text-zinc-700 dark:text-zinc-300 text-lg leading-relaxed'>
            Create viral, engaging ads to grow your brand and boost sales with
            TikTok’s dynamic platform. Let 3Zero Digital handle your campaign
            for maximum impact.
          </p>
          <Button className='p-5' asChild>
            <Link href='#getStarted'>Start My TikTok Campaign</Link>
          </Button>
        </div>
        <div className='flex justify-center md:w-1/2'>
          <SiTiktok className='w-48 h-48 text-pink-600' />
        </div>
      </section>
