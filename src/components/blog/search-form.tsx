  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <button
          aria-label='Search'
          className='flex items-center gap-2 hover:bg-gray-100 dark:hover:bg-gray-800 p-2 rounded-full transition'>
          <Search className='w-5 h-5 text-gray-700 hover:text-[#614385] dark:hover:text-[#614385] dark:text-gray-300 transition' />
          <span> Type to search blog posts</span>
        </button>
      </DialogTrigger>
      ...
      <DialogContent className='sm:max-w-[425px] lg:max-w-[550px]'>
        <DialogHeader>
          <DialogTitle>
            <div className='flex items-center border-gray-300 dark:border-gray-700 dark:bg-gray-800 px-3 py-2 border rounded-md focus-within:ring-2 focus-within:ring-[#614385]'>
              {isLoading ? (
        ...
        <DialogFooter>
          <div className='flex flex-wrap justify-start items-center gap-2 text-sm'>
            ...
            <Button
              ...
              className='px-2 py-1 text-[#614385] dark:text-[#614385]'>
              Malware Removal
            </Button>
            <Button
              variant='link'
