...
const MernSubmissionEmail: React.FC<MernSubmissionEmailProps> = ({
  formData,
}) => {
  const {
    projectType,
    ...
    <Html>
      ...
      <Body style={mainStyle}>
        <Container style={containerStyle}>
          <Heading style={headingStyle}>New MERN Project Submission</Heading>
...
export default MernSubmissionEmail;
