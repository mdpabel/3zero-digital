...
type FrontendSubmissionEmailProps = {
  formData: z.infer<typeof frontendFormSchema>;
};

const FrontendSubmissionEmail: React.FC<FrontendSubmissionEmailProps> = ({
  formData,
}) => {
  const {
    websiteType,
      ...
      <Body style={mainStyle}>
        <Container style={containerStyle}>
          <Heading style={headingStyle}>
            New Frontend Project Submission
          </Heading>
...
export default FrontendSubmissionEmail;
